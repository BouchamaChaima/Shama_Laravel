...
<body>
    <header>
        <nav>
            ...
            <ul class="menu">
                ...
                <li><a href="{{url('/About')}}" class="activ">
    ...
    <div class="cover">
        <div>
            <h1>About us</h1>
            <p>
                EDU-SHAM is a primary school Our mission is to make learning fun and easy for your child,
                Providing safe care and a friendly environment
                Where your child can grow and learn with help and guidance
                Positive role models and developmentally appropriate activities that are 
                important for developing students’ 
